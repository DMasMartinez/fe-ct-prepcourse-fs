...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var mascota={"nombre":nombre,"edad":edad};
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   var new_objeto={"nombre":nombre,"email":email,"password":password};
   return new_objeto
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   // Tu código:
   var resultado=0;
   var nuevoarreglo=objetoUsuario["posts"];
   for (var i=0 ; i<nuevoarreglo.length ; i++){
      resultado+=nuevoarreglo[i].likes
   }
   return resultado
}
